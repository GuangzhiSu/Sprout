  ...
  return (
    <main className="dash dash--student pick">
      <div className="pick__inner">
        <p className="pick__eyebrow">Step 1 of 1</p>
        ...
        <div className="pick__grid">
          <a className="pick-card pick-card--student" href="/student">
            ...
            <span className="pick-card__title display">I am the child</span>
          ...
          <a className="pick-card pick-card--parent" href="/parent">
            ...
            <span className="pick-card__title display">I am the parent</span>
            <span className="pick-card__sub">See scores, trends and recordings</span>
          </a>
        </div>

        <a className="pick__back" href="/landing/">← Back to the start</a>
      </div>
    </main>
  );
}
